...
if (file_exists(dirname(__FILE__).'/config/s_config.class.php')) {
    require_once (dirname(__FILE__).'/config/s_config.class.php');
} else {
    require_once (dirname(dirname(__FILE__)).'/baobab-config/s_config.class.php');
}
...
$rvp_php_sdk_test_manifest = [
                                ...
                                [
                                    ...
                                    'closure'   =>  [
                                                    ...
                                                    'file'      =>  'test-scripts/run_test_23_basic_put_tests.php'
                                                    ],
                                    'login'     =>  [
                                                    'login_id'  =>  'login-311',
                                                    'password'  =>  'CoreysGoryStory',
                                ...
                                [
                                    'blurb'     =>  'PEOPLE PUT TESTS (LOGINS)',
                                    'explain'   =>  'Basic People (Login) GET and PUT Tests.',
                                    'db'        =>  'sdk_1',
                                    'closure'   =>  [
                                                    'function'  =>  'run_test_29_people_tests',
                                                    'file'      =>  'test-scripts/run_test_29_people_tests.php'
                                                    ],
                                    'login'     =>  [
                                                    'login_id'  =>  'admin',
                                                    'password'  =>  'CoreysGoryStory',
                                ...
                                [
                                    'blurb'     =>  'PLACE DELETE TESTS',
                                    'explain'   =>  'Delete Places.',
                                    'db'        =>  'sdk_1',
                                    'closure'   =>  [
                                                    'function'  =>  'run_test_37_delete_places_tests',
                                                    'file'      =>  'test-scripts/run_test_37_delete_places_tests.php'
                                                    ],
                                    'login'     =>  [
                                                    'login_id'  =>  'MainAdmin',
                                                    'password'  =>  'CoreysGoryStory',
