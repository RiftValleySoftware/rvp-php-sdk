...
require_once(dirname(__FILE__).'/rvp_php_sdk_object.class.php');   // Make sure that we have the base class in place.

/****************************************************************************************************************************/
/**
 */
class RVP_PHP_SDK_Place extends RVP_PHP_SDK_Object {
    /************************************************************************************************************************/    
    ...
    function __construct(   $in_sdk_object,     ///< REQUIRED: The "owning" SDK object.
        ...
        parent::__construct($in_sdk_object, $in_id, $in_data, 'people/people');
    }
